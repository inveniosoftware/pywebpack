...
html_theme_options = {
    ...
    'github_repo': 'pywebpack',
    'github_button': False,
    'github_banner': True,
    'show_powered_by': False,
    'extra_nav_links': {
        'pywebpack@GitHub': 'https://github.com/inveniosoftware/pywebpack',
        'pywebpack@PyPI': 'https://pypi.python.org/pypi/pywebpack/',
    }
}
...
htmlhelp_basename = 'pywebpack_namedoc'
...
latex_documents = [
  (master_doc, 'pywebpack.tex', u'pywebpack Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'pywebpack', u'pywebpack Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'pywebpack', u'PyWebpack Documentation',
   author, 'pywebpack', 'Webpack integration layer for Python.',
   'Miscellaneous'),
]
